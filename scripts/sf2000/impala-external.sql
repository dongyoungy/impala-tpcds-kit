...
-- * schema name (currently tpcds_2000_text)
-- * location path (currently /tmp/tpc-ds/sf2000)

create schema if not exists tpcds_2000_text;
use tpcds_2000_text;
...
stored as textfile
location '/tmp/tpc-ds/sf2000/call_center'
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf2000/catalog_page'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf2000/catalog_returns'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf2000/catalog_sales'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf2000/customer'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf2000/customer_address'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf2000/customer_demographics'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf2000/date_dim'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf2000/household_demographics'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf2000/income_band'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf2000/inventory'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf2000/item'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf2000/promotion'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf2000/reason'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf2000/ship_mode'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf2000/store'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf2000/store_returns'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf2000/store_sales'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf2000/time_dim'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf2000/warehouse'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf2000/web_page'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf2000/web_returns'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf2000/web_sales'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/tmp/tpc-ds/sf2000/web_site'
tblproperties ('serialization.null.format'='')
;
