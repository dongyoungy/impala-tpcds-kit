...
select cs_sold_time_sk,
       ...
       cs_net_profit,
       cs_sold_date_sk
from tpcds_500_text.catalog_sales
...
select cr_returned_time_sk,
       ...
       cr_net_loss,
       cr_returned_date_sk
from tpcds_500_text.catalog_returns;
...
select ss_sold_time_sk,
       ...
       ss_net_profit,
       ss_sold_date_sk
from tpcds_500_text.store_sales
...
select sr_return_time_sk,
       ...
       sr_net_loss,
       sr_returned_date_sk
from tpcds_500_text.store_returns;
...
select wr_returned_time_sk,
       ...
       wr_net_loss,
       wr_returned_date_sk
from tpcds_500_text.web_returns;
