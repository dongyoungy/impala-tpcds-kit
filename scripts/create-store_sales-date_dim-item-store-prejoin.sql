...
create table if not exists store_sales_prejoin_date_dim_item_store (
  ss_sold_date_sk int,
  ss_sold_time_sk int,
  ss_item_sk int,
  ss_customer_sk int,
...
from store_sales left outer join date_dim on ss_sold_date_sk = d_date_sk 
left outer join item on ss_item_sk = i_item_sk
left outer join store on ss_store_sk = s_store_sk;
